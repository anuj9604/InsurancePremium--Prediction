...
from premium.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
    ...
    def export_model(self) -> ModelPusherArtifact:
        try:
            ...
            model_pusher_artifact = ModelPusherArtifact(
                export_model_file_path=export_model_file_path, is_model_pusher=True
            )
