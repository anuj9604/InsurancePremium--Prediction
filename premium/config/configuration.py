...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            csv_download_dir = os.path.join(
                ...
                data_ingestion_config[DATA_INGESTION_CSV_DOWNLOAD_DIR_KEY],
            )
            ...
            ingested_train_dir = os.path.join(
                ingested_dir, data_ingestion_config[DATA_INGESTION_TRAIN_DIR_KEY]
            )
            ingested_test_dir = os.path.join(
                ingested_dir, data_ingestion_config[DATA_INGESTION_TEST_DIR_KEY]
            )
            ...
            logging.info(
                "Data Ingestion Config fetched: {x}".format(x=data_ingestion_config)
            )
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            logging.info(
                "Data Validation Config fetched: {x}".format(x=data_validation_config)
            )
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            data_transformation_artifact_dir = os.path.join(
                artifact_dir, DATA_TRANSFORMATION_ARTIFACT_DIR_NAME, self.timestamp
            )
            ...
            transformed_train_dir = os.path.join(
                ...
                data_transformation_config[DATA_TRANSFORMATION_TRANSFORMED_DIR],
                data_transformation_config[DATA_TRANSFORMATION_TRAIN_DIR],
            )
            transformed_test_dir = os.path.join(
                data_transformation_artifact_dir,
                data_transformation_config[DATA_TRANSFORMATION_TRANSFORMED_DIR],
                data_transformation_config[DATA_TRANSFORMATION_TEST_DIR],
            )
            ...
            logging.info(
                "Data Transformation configuration fetched: {x}".format(
                    x=data_transformation_config
                )
            )
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            model_trainer_artifact_dir = os.path.join(
                artifact_dir, MODEL_TRAINER_ARTIFACT_DIR_NAME, self.timestamp
            )
            ...
            logging.info(
                "Model Trainer Configuration fetched: {x}".format(
                    x=model_trainer_config
                )
            )
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            ...
            model_evaluation_artifact_dir = os.path.join(
                artifact_dir, MODEL_EVALUATION_ARTIFACT_DIR_NAME, self.timestamp
            )
            ...
            logging.info(
                "Model Evaluation Configuration fetched {x}".format(
                    x=model_evaluation_config
                )
            )
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            export_dir_path = os.path.join(
                ROOT_DIR, model_pusher_config[MODEL_PUSHER_MODEL_EXPORT_KEY], time_stamp
            )

            model_pusher_config = ModelPusherConfig(export_dir_path=export_dir_path)
            logging.info(
                "Model Pusher Configuration fetched {x}".format(x=model_pusher_config)
            )
