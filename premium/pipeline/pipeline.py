...
from premium.component.model_trainer import *
from premium.component.model_evaluation import *
from premium.component.model_pusher import *
...
class Pipeline(Thread):
    ...
    def start_model_evaluation(
        self, data_ingestion_artifact, data_validation_artifact, model_trainer_artifact
    ):
        try:
    ...
    def start_model_push(self, model_evaluation_artifact):
        try:
    ...
    def run_pipeline(self):
        try:
            ...
            Pipeline.experiment = Experiment(
                ...
                message="Pipeline has completed.",
                experiment_file_path=Pipeline.experiment_file_path,
    ...
    def save_experiment(self):
        try:
            if Pipeline.experiment.experiment_id:
                ...
                print("First start an experiment")
